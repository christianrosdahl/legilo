...
- <kbd>⌘ Command</kbd> + <kbd>W</kbd>: Save all data and close the program. Alternatively, you can click the close button in the upper corner of the window, which will have the same effect.
